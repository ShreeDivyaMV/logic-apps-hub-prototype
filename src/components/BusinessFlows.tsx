...
import BusinessFlowTopology from './BusinessFlowTopology'
...
type DetailTab = 'Analytics' | 'Dependency Graph' | 'Message Trace' | 'Connections' | 'Dependencies'
